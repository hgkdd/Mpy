...
Dies ist die Grammatik von Daten-Dateien, die mit der Klasse
:class:`mpylab.tools.dataparser.DatFile` geparst werden können::
...
Erlaubte Einheiten und Umrechnungen stammen aus dem Dictionary ``uconv`` in
