...
_lr_productions = [
  ...
  ('line -> NEWLINE','line',1,'p_line_empty','dataparser.py',181),
  ('line -> FUNIT idanycase NEWLINE','line',3,'p_line_funit','dataparser.py',185),
  ('line -> UNIT idanycase NEWLINE','line',3,'p_line_unit','dataparser.py',190),
  ('line -> UNIT idanycase idanycase NEWLINE','line',4,'p_line_unit','dataparser.py',191),
  ('idanycase -> ID','idanycase',1,'p_idanycase_id','dataparser.py',199),
  ('line -> RELERROR FPNUMBER NEWLINE','line',3,'p_line_relerr','dataparser.py',204),
  ('line -> ABSERROR val NEWLINE','line',3,'p_line_abserr','dataparser.py',209),
  ('line -> FPNUMBER val val val NEWLINE','line',5,'p_line_data1','dataparser.py',215),
  ('line -> FPNUMBER val NEWLINE','line',3,'p_line_data2','dataparser.py',221),
  ('val -> number','val',1,'p_val_number','dataparser.py',234),
  ('number -> FPNUMBER','number',1,'p_number_fpnumber','dataparser.py',238),
  ('val -> LBRACE FPNUMBER COMMA FPNUMBER RBRACE','val',5,'p_val_ri','dataparser.py',243),
  ('val -> LSBRACE FPNUMBER COMMA FPNUMBER RSBRACE','val',5,'p_val_ma','dataparser.py',249),
]
