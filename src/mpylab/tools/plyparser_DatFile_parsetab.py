...
_lr_productions = [
  ...
  ('lines -> line lines','lines',2,'p_lines_line','dataparser.py',185),
  ('lines -> line','lines',1,'p_lines_line','dataparser.py',186),
  ('line -> NEWLINE','line',1,'p_line_empty','dataparser.py',190),
  ('line -> FUNIT idanycase NEWLINE','line',3,'p_line_funit','dataparser.py',194),
  ('line -> UNIT idanycase NEWLINE','line',3,'p_line_unit','dataparser.py',199),
  ('line -> UNIT idanycase idanycase NEWLINE','line',4,'p_line_unit','dataparser.py',200),
  ('idanycase -> ID','idanycase',1,'p_idanycase_id','dataparser.py',208),
  ('line -> RELERROR FPNUMBER NEWLINE','line',3,'p_line_relerr','dataparser.py',213),
  ('line -> ABSERROR val NEWLINE','line',3,'p_line_abserr','dataparser.py',218),
  ('line -> FPNUMBER val val val NEWLINE','line',5,'p_line_data1','dataparser.py',224),
  ('line -> FPNUMBER val NEWLINE','line',3,'p_line_data2','dataparser.py',230),
  ('val -> number','val',1,'p_val_number','dataparser.py',243),
  ('number -> FPNUMBER','number',1,'p_number_fpnumber','dataparser.py',247),
  ('val -> LBRACE FPNUMBER COMMA FPNUMBER RBRACE','val',5,'p_val_ri','dataparser.py',252),
  ('val -> LSBRACE FPNUMBER COMMA FPNUMBER RSBRACE','val',5,'p_val_ma','dataparser.py',258),
]
