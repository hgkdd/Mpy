...
_lr_productions = [
  ...
  ('line -> FPNUMBER val val val NEWLINE','line',5,'p_line_data1','dataparser.py',225),
  ('line -> FPNUMBER val NEWLINE','line',3,'p_line_data2','dataparser.py',231),
  ('val -> number','val',1,'p_val_number','dataparser.py',244),
  ('number -> FPNUMBER','number',1,'p_number_fpnumber','dataparser.py',248),
  ('val -> LBRACE FPNUMBER COMMA FPNUMBER RBRACE','val',5,'p_val_ri','dataparser.py',253),
  ('val -> LSBRACE FPNUMBER COMMA FPNUMBER RSBRACE','val',5,'p_val_ma','dataparser.py',259),
]
