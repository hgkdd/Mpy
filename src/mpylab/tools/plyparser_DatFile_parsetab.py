...
"""mpylab.tools.plyparser_DatFile_parsetab module."""
_tabversion = '3.10'
...
_lr_productions = [
  ...
  ('lines -> line lines','lines',2,'p_lines_line','dataparser.py',143),
  ('lines -> line','lines',1,'p_lines_line','dataparser.py',144),
  ('line -> NEWLINE','line',1,'p_line_empty','dataparser.py',148),
  ('line -> FUNIT idanycase NEWLINE','line',3,'p_line_funit','dataparser.py',152),
  ('line -> UNIT idanycase NEWLINE','line',3,'p_line_unit','dataparser.py',156),
  ('line -> UNIT idanycase idanycase NEWLINE','line',4,'p_line_unit','dataparser.py',157),
  ('idanycase -> ID','idanycase',1,'p_idanycase_id','dataparser.py',165),
  ('line -> RELERROR FPNUMBER NEWLINE','line',3,'p_line_relerr','dataparser.py',169),
  ('line -> ABSERROR val NEWLINE','line',3,'p_line_abserr','dataparser.py',174),
  ('line -> FPNUMBER val val val NEWLINE','line',5,'p_line_data1','dataparser.py',179),
  ('line -> FPNUMBER val NEWLINE','line',3,'p_line_data2','dataparser.py',191),
  ('val -> number','val',1,'p_val_number','dataparser.py',211),
  ('number -> FPNUMBER','number',1,'p_number_fpnumber','dataparser.py',215),
  ('val -> LBRACE FPNUMBER COMMA FPNUMBER RBRACE','val',5,'p_val_ri','dataparser.py',220),
  ('val -> LSBRACE FPNUMBER COMMA FPNUMBER RSBRACE','val',5,'p_val_ma','dataparser.py',228),
]
