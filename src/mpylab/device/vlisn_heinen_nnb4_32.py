...
class VLISN(VL):
    ...
    def _set_L1(self):
        self._set_pin_state(self._N_, 0)
        self._set_pin_state(self._L2_, 0)
        self._set_pin_state(self._L3_, 0)
        self._set_pin_state(self._L1_, 1)    # low for L
    ...
    def _set_L2(self):
        self._set_pin_state(self._N_, 0)
        self._set_pin_state(self._L1_, 0)
        self._set_pin_state(self._L3_, 0)
        self._set_pin_state(self._L2_, 1)    # low for L

    def _set_L3(self):
        self._set_pin_state(self._N_, 0)
        self._set_pin_state(self._L1_, 0)
        self._set_pin_state(self._L2_, 0)
        self._set_pin_state(self._L3_, 1)    # low for L

    def _set_N(self):
        self._set_pin_state(self._L1_, 0)    # low for L
        self._set_pin_state(self._L2_, 0)    # low for L
        self._set_pin_state(self._L3_, 0)    # low for L
        self._set_pin_state(self._N_, 1)   # low for N
    ...
    def Init(self, ini=None, channel=None, ignore_bus=True):
        ...
        self._set_as_digital_out(self._L1_)
        self._set_as_digital_out(self._L2_)
        self._set_as_digital_out(self._L3_)
...
def main():
    ...
    try:
        ...
        ini = format_block("""
                         [description]
                         DESCRIPTION = Heinen NNB-4/32T V-Type LISN
                         TYPE = VLISN
                         VENDOR = Heinen
                         SERIALNR = 
                         DEVICEID = 
                         DRIVER = vlisn_heinen_nn4_32.py
