# -*- coding: utf-8 -*-
"""Legacy metaclass driver framework.

This module was moved from :mod:`mpylab.device.meta_driver` to
:mod:`mpylab.device.legacy.meta_driver`. It is archived and not used by the
active drivers.
...
import inspect
import copy
from mpylab.device.legacy.r_types import *
