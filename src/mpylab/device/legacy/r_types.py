# -*- coding: utf-8 -*-
"""Legacy return type validators for the archived metaclass driver framework.

This module was moved from :mod:`mpylab.device.r_types` to
:mod:`mpylab.device.legacy.r_types`.
