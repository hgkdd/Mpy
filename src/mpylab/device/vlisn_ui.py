...
class VlisnWidget(QtWidgets.QWidget):
    ...
    def _build_plot_tab(self):
        ...
        range_row.addWidget(QtWidgets.QLabel("Data"))
        range_row.addWidget(self.plot_what_combo, 1)
        range_row.addWidget(QtWidgets.QLabel("Start"))
        range_row.addWidget(self.start_freq_control)
        range_row.addWidget(QtWidgets.QLabel("Stop"))
        range_row.addWidget(self.stop_freq_control)
        range_row.addStretch()
        action_row.addWidget(QtWidgets.QLabel("Points"))
        action_row.addWidget(self.points_spin)
        action_row.addWidget(QtWidgets.QLabel("Display"))
        action_row.addWidget(self.display_mode_combo)
        action_row.addWidget(self.plot_button)
        action_row.addWidget(self.export_csv_button)
        action_row.addWidget(self.clear_plot_button)
        action_row.addWidget(self.grid_button)
        action_row.addStretch()
        toolbar.addLayout(range_row)
