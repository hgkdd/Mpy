...
class DOT(yappsrt.Parser):
    ...
    def graph(self, _parent=None):
        ...
        if _token == "'graph|GRAPH'":
            ...
            if self._peek("'{'", 'ID', 'STR', 'NUM', "','", "'\\\\)'", "'='", "'--|->'", "'\\\\['", "':'", "'@'", "';'", "'}'", "'subgraph|SUBGRAPH'", "'graph|GRAPH'", "'node|NODE'", "'edge|EDGE'", "'\\\\]'") in ['ID', 'STR', 'NUM']:
                id = self.id(_context)
            self._scan("'{'")
            init_nodes_graph()
    ...
    def stmt_list(self, _parent=None):
        ...
        while self._peek("'}'", "'subgraph|SUBGRAPH'", "'{'", "'graph|GRAPH'", "'node|NODE'", "'edge|EDGE'", 'ID', 'STR', 'NUM') != "'}'":
            stmt = self.stmt(_context)
            if self._peek("';'", "'}'", "'subgraph|SUBGRAPH'", "'{'", "'graph|GRAPH'", "'node|NODE'", "'edge|EDGE'", 'ID', 'STR', 'NUM') == "';'":
                self._scan("';'")
        if self._peek() not in ["'}'", "'subgraph|SUBGRAPH'", "'{'", "'graph|GRAPH'", "'node|NODE'", "'edge|EDGE'", 'ID', 'STR', 'NUM']:
            raise yappsrt.SyntaxError(charpos=self._scanner.get_prev_char_pos(), context=_context, msg='Need one of ' + ', '.join(["'}'", "'subgraph|SUBGRAPH'", "'{'", "'graph|GRAPH'", "'node|NODE'", "'edge|EDGE'", 'ID', 'STR', 'NUM']))
